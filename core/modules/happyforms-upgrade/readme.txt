...
* Improvement: Added unregistered notice in Plugins screen.
* Bugfix: Better retro-compatibility for old Signature fields.
* Bugfix: Date-Time field "Min year" option was misbehaving.

= 1.25.10 =
* Bugfix: Old activities were erroneusly removed on some form configurations.

= 1.25.9 =
* New feature: "Show an error message if field contains words in Disallowed Comment Keys" for antispam integration with core settings.
...
* Removal: Signature field "Method" setting has been deprecated.
* Bugfix: Resumed submission sessions were causing errors in multi-page forms.
* Bugfix: PDF email attachments were causing unwanted removal of file uploads.
* Bugfix: Address field "Mode" settings preview wasn't working.
...
= 1.24.9 =
* Improvement: Added filter to disable automatic searchable behavior in dropdowns.
* Bugfix: Jetpack synchronization was triggering a fatal error.

= 1.24.8 =
* Improvement: Added filter for customizing Date-Time dropdown placeholders.
* Bugfix: Email me a copy of each submission → Email subject control was missing.
* Bugfix: Opt-In Choice field was missing.

= 1.24.7 =
* Improvement: Integrations can now be configured on a per-form basis.
* Improvement: Dashboard element colors have been brought in line with core.
...
* New feature: Added filter for changing the Stripe locale.
* Improvement: Better support for Elementor popups.
* Improvement: Long Answer field now suppports a minimum of 2 rows.
* Improvement: Better checks and notifications when trashing/deleting forms with activities.
* Bugfix: Screen reader styles were causing glitches on some themes.
* Bugfix: Consent Choice field was throwing an error when followed by a field without label.
* Bugfix: Style controls were not refreshing correctly after toggling "Use theme styles".
...
* Improvement: File Upload field field picker now reflects allowed file settings.
* Improvement: Support optional Signature fields.
...
* Bugfix: "Add 'other' choice" was misbehaving.
...
= 1.21.1 =
* New feature: New “Delete activity after set number of days” control for automated removal of activity after a set period of time.
* Improvement: Better styling control for choice fields option labels.
* Improvement: Better Star Rating Field styling when "Use theme styles" is active.
* Bugfix: Star Rating field was highlighting all five star on mouse over.
* Bugfix: Referral URL display was misbehaving on URLs with Chinese characters.
...
= 1.20.5 =
* Bugfix: PayPal integration wasn't working in live mode.
...
* Bugfix: Sendinblue mapped fields were misbehaving.
...
* Improvement: Added 6 new currencies to Payments field.
...
* Improvement: Added filters for Payments field transactions.
* Bugfix: Date-Time field was affected by minor glitches.
* Bugfix: ActiveCampaign integration was failing when submitting empty custom fields.
...
* Bugfix: Sendinblue integration wasn't working when submitting only Email fields.
...
* Bugfix: Sendinblue integration only pulled 10 lists per folder.
...
* Bugfix: Control for mapping form field to Mailchimp merge field was only showing first ten merge fields.
...
* Improvement: Merged three separate credit card inputs in Payment field into a single credit card input.
...
= 1.15.3 =
* Bugfix: Stripe credit card fields were not rendering when multiple forms were on the same page.

= 1.15.2 =
* Bugfix: PDF generation was triggering a deprecation warning.
* Bugfix: PayPal integration was triggering a notice on PHP 7.4.
* Bugfix: Sendinblue lists were not populating logic group dropdown with correct data.

= 1.15.1 =
* Bugfix: Forms with many parts generated long payment description beyond 1000 characters limit set by Stripe and PayPal.
* Bugfix: Some email marketing services were not showing lists in conditional logic dropdowns.
* Bugfix: Mailchimp groups were not populating logic group dropdown correctly when first enabling the integration.

= 1.15.0 =
* New feature: Added MailPoet integration.
* New feature: Added Sendinblue integration.
* New feature: Added SendFox integration.
...
= 1.14.0 =
* New feature: Integration with Google Analytics.
...
* New feature: New control in selected parts to include part value in payment description.
...
= 1.13.3 =
* Bugfix: A typo was preventing AWeber from fetching lists.

= 1.13.2 =
* Bugfix: Reworded ActiveCampaign control.

= 1.13.1 =
* Bugfix: An error in Constant Contact, AWeber and Active Campaign was blocking form submissions.

= 1.13.0 =
* New feature: Added AWeber integration.
* New feature: Added ActiveCampaign integration.
* New feature: Added Constant Contact integration.
* New feature: Added SendGrid integration.
* New feature: Added ConvertKit integration.
* New feature: Added MailerLite integration.
...
= 1.12.13 =
* Bugfix: Removed undefined constant.
...
= 1.12.10 =
* Improvement: Improved compatibility with latest version of Divi theme.
...
* New feature: Stripe integration now supports Indian rupee (INR) and Romanian leu (RON) currencies.
...
* Bugfix: Long Text part was ignoring new lines when displaying submitted value in emai
...
= 1.4.1 =
* Improvement: Better display of response analytics.
...
= 1.24.8 =
* Missing Email me a copy of each submission → Email subject control and Opt-In Choice field, Date-Time placeholders filter.
...
= 1.21.1 =
* New “Delete activity after set number of days” control, styling improvements and bugfixes.
